...
const HireSupport = () => {
    ...
    return (
        <div style={{ background: '#030303' }}>
            ...
            <motion.section className='hire-support-features-section'>
                <motion.div className='hire-support-features'>
                    <motion.div
                        className='feature1'
                        ref={refFeature1}
                        initial="hidden"
            ...
            {/* <motion.section className='hire-support-features-section'
                ...
                variants={containerVariants}>
                <motion.div className='hire-support-features'>
                    <motion.div className='feature1' variants={containerVariants}>
                        <motion.h1 className='header' variants={itemVariants}>
                            Experience Exceptional <span style={{ color: '#2A71FA' }}>Customer Support</span> with Inflexion Teams
                        </motion.h1>
                    ...
                    <motion.div className='feature2' variants={containerVariants}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem', alignItems: 'center' }}>
                            <motion.h1 className='header' variants={itemVariants}>
                                Get expert AI-powered outsourcing assistance
                            </motion.h1>
